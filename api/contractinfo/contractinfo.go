...
// T describes the fields of the mercury-contract config which are publicly
...
type T struct {
	...
	// Version is the version of this mercury-contract.
	Version semver.Version `json:"version"`
	// Endpoint is the publicly accessible URL of this mercury-contract instance.
...
// Payout is the section describing the configured payout method.
type Payout struct {
	// Endpoint is the URL of the payment system (usually mercury-auth for now).
...
type Directory struct {
	// Endpoint is the URL of the mercury-dir instance keeping a directory of
